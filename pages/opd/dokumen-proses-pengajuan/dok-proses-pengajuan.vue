<template>
  <div>
    ...
    <div class="flex">
      <div class="basis-1/4 ml-6 mt-4 inline-block">
        <span>3. Dokumen Proses Pengajuan Hosting dan Sub-Domain</span>
        <!--  -->
        <p>
      ...
      <div class="basis-3/4 ml-32 mr-10">
        <div class="relative flex flex-col ml-4 mt-3">
          <label for="" class="mb-2">Surat Permohonan Assessment</label>

          <input type="file" class="mb-2" />
          <button
            class="bg-blue-500 text-white p-1 w-1/4 rounded-full hover:bg-blue-900"
          >
            Submit
          </button>
        </div>
        ...
        <div class="flex flex-col mt-6 ml-4">
          ...
          <label class="inline-flex items-center">
            ...
            <input
              type="radio"
              class="form-radio text-blue-600 ml-3"
              name="option"
              value="option2"
            />
