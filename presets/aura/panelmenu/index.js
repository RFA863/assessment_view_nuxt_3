export default {
    panel: {
        class: 'p-1 overflow-hidden mb-3  dark:border-surface-700 rounded-md'
    },
    header: {
    ...
    headercontent: ({ context, instance }) => ({
        class: [
            ...
            // States
            'hover:bg-slate-600 dark:hover:bg-[rgba(255,255,255,0.03)]',
            'hover:text-white',
    ...
    action: ({ context }) => ({
        class: [
            ...
            // States
            'hover:bg-slate-600 dark:hover:bg-[rgba(255,255,255,0.03)] hover:text-white dark:hover:text-white/80',
            {
